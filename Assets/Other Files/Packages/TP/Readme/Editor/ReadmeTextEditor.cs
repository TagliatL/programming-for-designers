...
namespace TP
{
    public class ReadmeTextEditor
    {
        ...
        public bool multiline { get => TextEditor.isMultiline; set { if(HasTextEditor) TextEditor.isMultiline = value; }}
        ...
        public bool hasHorizontalCursorPos { get => TextEditor.hasHorizontalCursor; set { if(HasTextEditor) TextEditor.hasHorizontalCursor = value; }}
