...
public class TravelingProjectile : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //here comes the cool part, we're raycasting twice
        //this time, it's to account for bullets that are too fast they could pass through wall inbetween two frames
        //we use a raycast from our current position to the position we expect the bullet to be next frame and see if there is any wall that intersects
